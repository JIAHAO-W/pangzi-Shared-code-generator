...
public class MetaValidator {
    ...
    public static void validAndFillModelConfig(Meta meta) {
        ...
        List<Meta.ModelConfigDTO.ModelsInfo> modelInfoList = modelConfig.getModels();
        ...
        for (Meta.ModelConfigDTO.ModelsInfo modelInfo : modelInfoList) {
            ...
            if (StrUtil.isBlank(fieldName)) {
                throw new MetaExeception("未填写 fieldName");
    ...
    public static void validAndFillFileConfig(Meta meta) {
        ...
        if (StrUtil.isBlank(sourceRootPath)) {
            throw new MetaExeception("未填写 sourceRootPath");
        }
        ...
        for (Meta.FileConfigDTO.FilesInfo fileInfo : fileInfoList) {
            ...
            if (StrUtil.isBlank(inputPath)) {
                throw new MetaExeception("未填写 inputPath");
            }
